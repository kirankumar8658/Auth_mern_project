...
const Login = () => {
 ...
 const onSubmitHandler = async (e) => { 
  ...
  return (
    <div  className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-linear-to-r from-blue-200 via-blue-400 to-blue-600/">
      ...
      <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <p onClick={()=>navigate('/reset-Password')} className="mb-4 text-indigo-500 cursor-pointer">Forgote password?</p>
